...
```go
import "github.com/FlamingTree/expr"
...
[ast](https://godoc.org/github.com/FlamingTree/expr/ast) package provides `Visitor` interface and `BaseVisitor` implementation. 
You can use it for traveling ast tree of compiled program.

For example if you want to collect all variable names:

```go
import "github.com/FlamingTree/expr/ast"
